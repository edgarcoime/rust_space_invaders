...
use crate::{utils::RenderedAssetInfo, shared::{Health, WorldPhysicsLayer}, WinSize};

// region:      Constants
const DEFAULT_OBSTACLE_AMOUNT: u32 = 4;
const OBSTACLE_BLOCK_SIZE: f32 = 6.;
// const OBSTACLE_BLOCK_SIZE: f32 = 30.;
...
impl BlockBundle {
    fn new(x: f32, y: f32, color: Color) -> Self {
        ...
        Self {
            ...
            _rb: RigidBody::Sensor,
            _cs: CollisionShape::Cuboid {
                half_extends: obs_size.extend(0.) / 2.,
                border_radius: None,
            },
            _cl: CollisionLayers::none()
                .with_group(WorldPhysicsLayer::Obstacle)
                .with_mask(WorldPhysicsLayer::Projectile)
